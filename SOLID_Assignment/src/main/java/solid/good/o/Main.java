...
public class Main {
    public static void main(String[] args) {
        ...
        List<Product> filterByBlackListedProducts = productManager.blacklistedProducts();
        System.out.println("Filtered by blacklisted products:");
        for (Product product : filterByBlackListedProducts) {
            productManager.printProductDetails(product);
        }
